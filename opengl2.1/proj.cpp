...
static void
imgLoad(const char *filenameIn, int borderIn, GLfloat borderColorIn[4],
...
main(int argc, char **argv)
{
    ...
    texFilename = "/Users/glp/Documents/codeEx/sgi/SGI/SIGGRAPH99/data/mandrill.rgb";
